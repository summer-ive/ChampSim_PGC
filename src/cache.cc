...
uint32_t CACHE::impl_prefetcher_cache_operate(uint32_t cpu, champsim::address addr, champsim::address v_addr, champsim::address ip, bool cache_hit,
                                              bool useful_prefetch, access_type type, uint32_t metadata_in) const
{
  return pref_module_pimpl->impl_prefetcher_cache_operate(cpu, addr, v_addr, ip, cache_hit, useful_prefetch, type, metadata_in);
}
