...
uint32_t spp_dev_pgc::prefetcher_cache_operate(uint32_t trigger_cpu, champsim::address trigger_paddr, champsim::address trigger_vaddr, champsim::address ip,
                                               bool cache_hit, bool useful_prefetch, access_type type, uint32_t metadata_in)
{
  ...
  FILTER.check(trigger_paddr, spp_dev_pgc::L2C_DEMAND);
...
void spp_dev_pgc::prefetcher_final_stats()
{
