#ifndef SPP_PGC_PTE_DEBUG_H
#define SPP_PGC_PTE_DEBUG_H
...
struct spp_pgc_pte_debug : public champsim::modules::prefetcher {
  ...
  std::vector<pte_buffer_type> pte_buffer{NUM_CPUS};
